...
// define background
var imgBg = require("heatshrink").decompress(atob(""));
...
var imgSteps = require("heatshrink").decompress(atob("jEYwUBqoANgoEDqgVEAooRFAAtQBYkAC4dQAotAAodAoEAAoVRoEUDwdAioFFFIgFEgg1EgoFPqgoEAooAKA"));

var imgBattery = require("heatshrink").decompress(atob("jEYwMB/4AQ8EAj/AgEP5//54CB4YCE+YCEBYvPDQQgCGqIA="));

var imgSeparator = E.toArrayBuffer(atob("BhsBAAAAAA///////////////AAAAAAA"));
...
function draw(){
  ...
  if (w == 5) {imgW = imgFri;}
  if (w == 6) {imgW = imgSat;}
  g.drawImage(imgW, 85, 68);


   //draw separator
  if (separator){
  g.drawImage(imgSeparator, 85,103);}
  ...
  g.drawString(h, 25, 96, true);
  g.drawString(("0"+m).substr(-2), 92, 96, true);
  // draw date
  g.setFontCustom(fontDate, 48, 12, 15);
  g.drawString(("0"+d).substr(-2), 123,68, true);

  g.reset();
  g.drawImage(imgSteps, 14, 37);

  g.reset();
  g.setColor(0,0,0);
  g.setBgColor(1,1,1);
  g.setFont("5x7Numeric7Seg", 2);
  g.drawString(getSteps(), 40, 43);

  g.reset(); 
  g.drawImage(imgBattery, 124, 36);

  var batx = Math.floor(getBattery()*11/100);
  g.setColor(0,0,0);
  g.setBgColor(1,1,1);
  g.fillRect(129, 45, 129+batx, 50);
